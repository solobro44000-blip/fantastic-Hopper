...
# --- Configuration ---
TOKEN = '8450753997:AAEKQ-LaeWWOcFwGoAtZGe-6AJ9lZwZ0k3Q' # Replace with your actual token
...
if __name__ == '__main__':
    logger.info("="*40 + "\n🤖 Bot Starting Up (Webhook Mode)...\n" +
                f"🐍 Python: {sys.version.split()[0]}\n" +
                f"🔧 Base Dir: {BASE_DIR}\n📁 Upload Dir: {UPLOAD_BOTS_DIR}\n" +
                f"📊 Data Dir: {IROTECH_DIR}\n🔑 Owner ID: {OWNER_ID}\n🛡️ Admins: {admin_ids}\n" +
                "="*40)

    # Purana webhook hatao
    bot.remove_webhook()

    # Render external URL (Render env me hota hai)
    WEBHOOK_HOST = os.getenv("RENDER_EXTERNAL_URL", "https://hostingbot-urd7.onrender.com")
    ...
    # Flask server start hoga (Render use run karega)
